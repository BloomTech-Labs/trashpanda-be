...
describe('testing typeDefs', () => {
  ...
  describe('reducers in earth datasource', () => {

    it('reduces mock materials using materialReducer', async () => {
      let earthAPI = new Earth911()
      const binInfo = mockResponses
      const res = earthAPI.materialReducer(binInfo.mockMaterials[1], binInfo.mockMaterials[0])
    ...
    it('reduces mock families using familyReducer', async () => {
      let earthAPI = new Earth911()
      const binInfo = mockResponses
      const res = earthAPI.familyReducer(binInfo.mockFamilies[0])
    ...
    it('reduces mock postal information using locationObjReducer', async () => {
      let earthAPI = new Earth911()
      const binInfo = mockResponses
      const res = earthAPI.locationObjReducer(binInfo.mockPostal)
    ...
    it('reduces mock locations using locationReducer', async () => {
      let earthAPI = new Earth911()
      const binInfo = mockResponses
      const res = earthAPI.locationReducer(binInfo.mockLocationDetails)
  
       expect(res.full_address).toEqual("860 Sun Dr, Lake Mary, FL 32746" );
    });
...
//             bin_special: false
//     }
//     expect(res.data.materials[0]).toMatchObject(testObj);
//  });
  // });
